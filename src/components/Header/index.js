    ...
    <>
      <header className={props.className}>
        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:p-[10px] p-[15px] sm:p-[7px] w-[100%]">
          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-center mb-[14px] sm:mb-[7px] md:mb-[9px] md:ml-[53px] ml-[78px] md:mt-[11px] mt-[17px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[30%]">
