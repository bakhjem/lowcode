    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-chivo items-center justify-start mx-[auto] w-[100%]">
        ...
        <Column className="flex flex-col items-center justify-start sm:mt-[37px] md:mt-[48px] mt-[70px] w-[100%]">
          ...
          <Stack className="bg-teal_401 h-[653px] mt-[100px] sm:mt-[53px] md:mt-[68px] sm:p-[15px] md:p-[27px] p-[40px] relative w-[100%]">
            <Row className="absolute flex flex-row md:flex-wrap sm:flex-wrap items-center left-[11%] sm:mx-[0] sm:px-[0] top-[10%] sm:w-[100%] w-[78%]">
              <Img
